...
//------------------------------------------------------------------------------
// This is a simple memory module with 256 Bytes memory size, supporting byte,
// halfword, and fullword (32bits) access
//------------------------------------------------------------------------------
...
//        cout<<"size of test data struct is " << dec << sizeof(test_s)<<endl;
        ...
        test_data.a = 0xA0;
        test_data.b = 0xB1B0;
        test_data.c = 0xC3C2C1C0;
        
        

        
        
        memcpy(&mem[0x04], &test_data, sizeof(test_data));
