 ...
 * @date    09.07.2018
 *
 * @brief   Main program of TLM_demo3 (temporal decoupling version)
 *
...
int sc_main(int argc, char* argv[])
{
    ...
    tlm::tlm_global_quantum &g_quatum = tlm::tlm_global_quantum::instance();
    g_quatum.set( sc_core::sc_time(20, sc_core::SC_NS ));
